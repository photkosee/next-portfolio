            ...
            <div className="flex flex-col lg:flex-row gap-3 w-full">
              <div className="flex flex-col sm:flex-row gap-3">
                <div
                  ...
                  w-full border rounded-2xl flex-1 justify-center items-center dark:bg-secondary/40"
                >
              ...
              <div
                ...
                mx-auto w-full border rounded-2xl flex-1 justify-center items-center dark:bg-secondary/40"
              >
            ...
            <div className="flex flex-col md:flex-row gap-3 w-full">
              ...
              >
                <div
                  ...
                  border rounded-2xl flex-1 justify-center items-center dark:bg-secondary/40"
                >
                  <Link
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 max-w-[350px]">
                    {showcase1.map((tool, index) => (
                      ...
                      >
                        <div className="text-muted-foreground">{tool.name}</div>
                        {tool.icon && (
                          <StackIcon
                            name={tool.icon}
              ...
              <div className="w-full flex flex-col justify-between">
                ...
                <div
                  className="w-full lg:self-end flex flex-col sm:flex-row justify-center
                  gap-y-1 gap-x-2 pt-5"
                >
                  <div className="flex flex-col xs:flex-row gap-x-2 gap-y-1 max-w-[300px] mx-auto w-full sm:mx-0">
                    <Link
                    ...
                    >
                      <Button
                        variant="outline"
                        className="gap-1 px-3 bg-secondary text-white hover:bg-secondary/90 hover:text-white w-full"
                        size="sm"
                      >
                        More Details
                      </Button>
                    ...
                    >
                      <Button
                        variant="outline"
                        className="w-full gap-1 px-3 bg-secondary text-white
                  ...
                  <Link
                    ...
                    passHref
                    target="_blank"
                    className="w-full sm:w-auto max-w-[300px] mx-auto sm:mx-0"
                  >
                    <Button
                      variant="outline"
                      className="w-full gap-1 px-3 bg-secondary text-white hover:bg-secondary/90 hover:text-white"
                      size="sm"
                    >
                      Source Code
