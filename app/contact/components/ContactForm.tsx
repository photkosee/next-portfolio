...
const ContactForm = () => {
  ...
  const validateInput = () => {
    const urlRegexs = [/(https?:\/\/[^\s]+)/gm, /(http?:\/\/[^\s]+)/gm];
  ...
  return (
    <form className="flex flex-col gap-3 z-10" onSubmit={sendEmail}>
      <div>
        <Label htmlFor="name" className="ml-3 text-base">
          Name
        </Label>
      ...
      <div>
        <Label htmlFor="email" className="ml-3 text-base">
          Email
        </Label>
        <div className="relative flex items-center">
          <Input
      ...
      <div>
        <Label htmlFor="message" className="ml-3 text-base">
          Message
        </Label>
        <div className="relative flex items-center">
          <Textarea
            ...
            "
            id="message"
            placeholder="What'd you like to discuss about?"
            value={message}
